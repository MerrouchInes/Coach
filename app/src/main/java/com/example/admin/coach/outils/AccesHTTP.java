...
public class AccesHTTP extends AsyncTask<String, Integer, Long> {
	//AsyncTask de type Thread: s'exécute dans un processus isolé, sans bloquer le reste de l'application.
	public String ret="";
	private ArrayList<NameValuePair> parametres;
	public com.example.admin.coach.outils.AsyncResp+onse delegate=null;
